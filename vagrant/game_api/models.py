...
class SpeakerForm(messages.Message):
    ...
    briefBio   = messages.StringField(2)
...
class Session(ndb.Model):
    ...
    duration      = ndb.IntegerProperty()  # In number of minutes
...
class SessionForm(messages.Message):
    ...
    speakerKey    = messages.StringField(3, repeated=True)
    duration      = messages.IntegerField(4)  # In number of minutes
    typeOfSession = messages.EnumField('SessionType', 5)
    date          = messages.StringField(6)
    month         = messages.IntegerField(7)
    startTime     = messages.StringField(8)
    parentKey = messages.StringField(9)
